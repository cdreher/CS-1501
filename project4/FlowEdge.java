...
public class FlowEdge {
    ...
    //Initializes a flow edge from input array (data)
    public FlowEdge(String[] data) {
        ...
        this.capacity = Double.parseDouble(data[3]);		//fourth user input is bandwith (e.g. edge capacity)
        this.flow      = 0.0;
    }
